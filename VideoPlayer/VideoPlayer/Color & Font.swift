...
extension UIColor {
    ...
    class var darkBlueGreyTwo: UIColor {
        return UIColor(red: 8.0 / 255.0, green: 21.0 / 255.0, blue: 35.0 / 255.0, alpha: 1.0)
    }

    class var purplishGrey: UIColor {
...
extension UIFont {
    ...
    class func textStyle28Font() -> UIFont {
    ...
    class func textStyle29Font() -> UIFont {
        return UIFont.systemFont(ofSize: 14.0, weight: UIFontWeightRegular)
    }
